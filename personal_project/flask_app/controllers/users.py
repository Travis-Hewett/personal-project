...
def dashboard():
    ...
    print(cut.Cut.get_all_cuts_with_users())
    return render_template("dashboard.html", this_user = user.User.get_user_by_id(data), all_cuts = cut.Cut.get_all_cuts_with_users())
...
def my_cuts_page():
    ...
    return render_template("update_user.html", this_user_with_cuts = cut.Cut.get_cuts_by_this_user(data))
...
def checkout():
    ...
    return render_template ("cart.html", this_user_with_cuts = cut.Cut.get_cuts_by_this_user(data))
